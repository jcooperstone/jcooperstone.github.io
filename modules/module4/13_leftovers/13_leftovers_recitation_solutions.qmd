...
income_by_lifeexp_anim <- gapminder |>
  ...
  scale_x_continuous(trans = "log2", labels = scales::dollar_format()) +
  scale_size_area(guide = "none") +
  coord_cartesian(ylim = c(0, 90)) + # set limits on y-axis range
  theme_minimal() +
  theme(legend.position = "top", # change legend location
...
Save your plot.
```{r viz2 save, eval = FALSE}
anim_save(filename = "gapminder2_gif.gif",

...
After you perform PCA analysis, you can use `autoplot()` to create a ggplot2 
...
Code taken from [OSU's Code Club](https://biodash.github.io/codeclub/s02e12_plotly/)
...
You can export your interactive plots by using the [`saveWidget()`](https://www.rdocumentation.org/packages/htmlwidgets/versions/1.6.4/topics/saveWidget) function from
the package `htmlwidgets`. If you do not have this package, you can install it by:

```{r include=TRUE, eval=FALSE}
install.packages("htmlwidgets")
```

Now we can create an ggplotly object to save, and then save it as a standalone `.html`. Remember this will save only your plot, not your whole RMarkdown.
```{r eval=FALSE, include=TRUE}

...
Today we are using real research data from my group. We will be reading in the supplementary data from a [paper](https://acsess.onlinelibrary.wiley.com/doi/full/10.1002/tpg2.20192) written by Michael Dzakovich, and published in The Plant Genome. 

::: {.callout-tip}
## Download today's data

You can download the Excel file from [the supporting information link](https://acsess.onlinelibrary.wiley.com/doi/full/10.1002/tpg2.20192), or you can access it directly [here](https://github.com/jcooperstone/jcooperstone.github.io/raw/refs/heads/main/modules/module3/07_distributions/tpg220192-sup-0002-supmat.xlsx). 
:::
...
Jittering introduces a small amount of variation into your points so they're easier to see. 

- A width of `0` is no *horizontal* jitter
- A height of `0` is no *vertical* jitter

Typically you **don't want veritcal jitter** so that the points retain their fidelity on the y-axis (which is where their concentration is plotted). I basically always use `geom_jitter(height = 0)` for plots where I want to retain y-axis fidelity.
...
### [`ggridges::geom_density_ridges()`](https://www.rdocumentation.org/packages/ggridges/versions/0.5.2/topics/geom_density_ridges)

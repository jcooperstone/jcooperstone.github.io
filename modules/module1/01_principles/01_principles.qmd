...
subtitle: "Week 1<br>8/26/2025 <br>💻 🧰 📊 🥳"
...
You do not need to be an R expert for this class, but I will assume working-level knowledge of R programming. If you have no experience with R, but would still like to take this class, you can. I ask then you get yourself up to speed by taking this free online class [https://www.edx.org/course/data-science-r-basics](https://www.edx.org/course/data-science-r-basic) (audit only) before the start of the 3rd week of class. 
...
*November 11* is Veterans Day (no class) <br>
...
::: {.fragment}
We will go through these next week. Daniel will pick the best good and the best bad visualizations and there will be prizes! 🎉
:::
